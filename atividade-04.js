...
console.log(percentualDesconto = precoOriginal * (percentualDesconto/ 100));
let valorDesconto = 37.5
console.log(valorDesconto = precoOriginal * (percentualDesconto/ 100))
console.log( precoOriginal - valorDesconto)
let precoFinal = 156.25
...
console.log(pontos);
pontos *=2
let multiplicação = 240
console.log(pontos);
pontos /=4
let divisão = 60
console.log(pontos);
console.log(`Pontos após adicao: ${adicao}`);
console.log(`Pontos após subtração: ${subtração}:`);
console.log(`Pontos após multiplicação: ${multiplicação}`);
console.log(`Pontos após divisão: ${divisão}`);
// ------------------------------------------------------------
...
let ceil = 8
console.log(`Esta é math round: ${round}`);

console.log(`Esta é math floor: ${floor}`);

console.log(`Esta é math ceil: ${ceil}`);
...
console.log(user.nota1+user.nota2+user.nota3)
let resultado= 18
resultado /=3
