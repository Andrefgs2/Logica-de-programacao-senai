...
// → Seu código aqui:
var MeuNome = 'Andre'
var naoUsarVar = 'pq é feio'
let minhaIdade = 20
const ANO_NASCIMENTO = 2005
console.log (`meu nome é: ${MeuNome} não é legal brigar ${naoUsarVar}tenho ${minhaIdade} anos e nasci em ${ANO_NASCIMENTO}`)
