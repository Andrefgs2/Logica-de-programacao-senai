...
// b) Exiba a cidade
    aluno.endereco = "Jaraguá do sul, Rua Thais Batista";
    console.log(aluno)
...
// → Seu código aqui:
    aluno.habilidades = ["jogar futebol", "lutar"]
    console.log(aluno)
...
// → Seu código aqui:
    aluno.notas = [7, 8, 9, 10]
    console.log(aluno)
    console.log(`aluno: ${aluno.nome} obteve as seguintes notas ${aluno.notas}`)
console.log("_______________________________");
...
// → Seu código aqui:
    aluno.responsavel = "nilda mãe do aluno"
    console.log(aluno.responsavel)
    aluno.responsavel = "maria, irmã do aluno"
    console.log(aluno.responsavel)
console.log("_______________________________");
...
// → Seu código aqui:
    ...
    let aluno2 = {
        ...
        let aluno3 = {
            ...
            aluno.listaDeAlunos = [aluno, aluno2, aluno3]
...
let Aluno2 = {
 ...
 let Aluno3 = {
        ...
        idade: 22,
        notas: [1,2,3]}
    let ListaAlns = [aluno1, Aluno2, Aluno3]
    console.log(ListaAlns)
